...
Functions implemented in einexpr/array_api/einarray_object.py
    ...
    ✅  einexpr.array_api.einarray_object.einarray.isolate_dims(self: array, dims: Iterable[AtomicDimension], split_mode: Literal["left", "middle", "right"] = "middle")                    
    ...
    ✅  einexpr.array_api.einarray_object.einarray.__getitem__(self: array, key: Union[int, slice, EllipsisType, Tuple[Union[int, slice, EllipsisType], ...], array, einexpr.array_api.dimension.NestedDimension, Tuple[einexpr.array_api.dimension.NestedDimension, ...]], /)                     
...
Functions implemented in einexpr/array_api/dimension.py
    ✅  einexpr.array_api.dimension.AbsorbingDimension.__str__(self)                         
    ✅  einexpr.array_api.dimension.AbsorbingDimension.__repr__(self)                        
    ✅  einexpr.array_api.dimension.AbsorbingDimension.__eq__(self, other: object)                          
    ✅  einexpr.array_api.dimension.AbsorbingDimension.__hash__(self)                        
    ...
    ✅  einexpr.array_api.dimension.dims(n: UnparsedDimensions)                            
    ✅  einexpr.array_api.dimension.dims(x)                            
    ✅  einexpr.array_api.dimension.DimensionSpecification.__post_init__(self)                   
    ✅  einexpr.array_api.dimension.DimensionSpecification.__post_init__.<locals>.verify_dimensions(dimensions)               
    ✅  einexpr.array_api.dimension.DimensionSpecification.shape(self)                           
    ✅  einexpr.array_api.dimension.DimensionSpecification.shape.<locals>.deep_product(value: Tuple | int)                    
    ✅  einexpr.array_api.dimension.DimensionSpecification.with_dimensions(self, dimensions: Iterable[AtomicDimension])                 
    ✅  einexpr.array_api.dimension.DimensionSpecification.get_dimension_size_components(self, dimension: BaseDimension)   
    ✅  einexpr.array_api.dimension.DimensionSpecification.compute_dimension_size(self, dimension: BaseDimension)          
    ✅  einexpr.array_api.dimension.DimensionSpecification.can_compute_dimension_size(self, dimension: BaseDimension)      
    ✅  einexpr.array_api.dimension.DimensionSpecification.get_unsized_dims(self)                
    ✅  einexpr.array_api.dimension.DimensionSpecification.get_unsized_dims.<locals>._get_unsized_dims(dims)               
    ✅  einexpr.array_api.dimension.DimensionSpecification.__iter__(self)                        
    ✅  einexpr.array_api.dimension.DimensionSpecification.__len__(self)                         
    ✅  einexpr.array_api.dimension.DimensionSpecification.__getitem__(self, index)                     
    ✅  einexpr.array_api.dimension.DimensionSpecification.index(self, dimension)                           
    ✅  einexpr.array_api.dimension.DimensionSpecification.__repr__(self)                        
    ✅  einexpr.array_api.dimension.DimensionSpecification.copy(self)                            
