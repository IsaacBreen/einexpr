...
Functions implemented in einexpr/array_api/einarray_object.py
    ...
    ✅  einexpr.array_api.einarray_object.einarray.coerce(self: array, dims: Tuple[_AtomicDimension])                          
    ✅  einexpr.array_api.einarray_object.einarray.isolate_dims(self: array, dims: Iterable[_AtomicDimension])                    
...
Functions implemented in einexpr/array_api/dimension.py
    ...
    ✅  einexpr.array_api.dimension._AtomicDimension.id(self)                              
    ...
    ✅  einexpr.array_api.dimension.DimensionTuple.__init__(self, dimensions: Iterable[_AtomicDimension] = ())                        
    ...
    ✅  einexpr.array_api.dimension.DimensionReplacement.__init__(self, original: _AtomicDimension, replacement: _AtomicDimension)                        
