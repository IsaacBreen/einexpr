...
Functions implemented in einexpr/array_api/einarray_object.py
    ...
    ✅  einexpr.array_api.einarray_object.einarray.coerce(self: array, dims: Tuple[Dimension])                          
    ✅  einexpr.array_api.einarray_object.einarray.isolate_dims(self: array, dims: Iterable[Dimension])                    
...
Functions implemented in einexpr/array_api/dimension.py
    ...
    ✅  einexpr.array_api.dimension.Dimension.id(self)                              
    ...
    ✅  einexpr.array_api.dimension.DimensionTuple.__init__(self, dimensions: Iterable[Dimension] = ())                        
    ...
    ✅  einexpr.array_api.dimension.DimensionReplacement.__init__(self, original: Dimension, replacement: Dimension)                        
